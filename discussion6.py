    ...
    def load_results(self, table):
        ...
        for row in table[1:]:
            ...
            for i in range(1, len(headers)):
                ...
                results[horse_name][race_name] = race_time
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict:
            best_race, best_time = self.horse_fastest_race(horse)
            bests[horse] = (best_race, best_time)
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        for horse in self.race_dict:
            times = self.race_dict[horse].values()
